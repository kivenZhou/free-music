...
| 当前版本 | [v0.1.0](https://github.com/kivenZhou/free-music/releases/tag/v0.1.0) |
| 许可证 | [MIT](./LICENSE) |
| 发行页 | [GitHub Releases](https://github.com/kivenZhou/free-music/releases) |

> **重要**：仅聚合各站已开放的免费完整流。会员专属、下架或试听截断内容无法播放；播放结果取决于源站策略，本项目不提供破解或绕过版权的能力。
...
- 本软件仅供学习与个人使用。使用时请遵守各音源平台服务条款及所在地法律法规。
- 不提供破解会员、绕过版权保护或其它违法用途。曲目能否播放，完全取决于源站是否开放免费完整流。
- 第三方接口可能变更或限流；榜单为空、加载失败时请稍后重试。
