...
桌面端多音源音乐客户端。聚合网易云、哔哩哔哩、酷狗、酷我，以及 **Audius**（开放音源、免登录）等平台的**可免费完整播放**曲目，在本地完成榜单浏览、搜索、收藏、歌单与播放，无需登录、无需自建服务端。
...
3. **平台关系**  
   本项目为独立开源作品，与网易云、哔哩哔哩、酷狗、酷我、Audius 等平台**无官方合作、授权或隶属关系**。Audius 曲目多为艺人自行上传分发；Openverse、Internet Archive、YouTube 等海外源在国内多数网络下不可达，故不默认接入。请遵守各平台服务条款；若平台调整接口、限制访问或要求停止使用某能力，相关功能可能随时失效，届时应停止继续使用该音源。
